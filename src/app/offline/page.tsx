...
export const metadata: Metadata = { title: "Offline — Nativa", robots: { index: false } };
...
export default function Offline() {
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-lg flex-col items-center justify-center gap-4 px-5 text-center">
      ...
      <Link href="/plan" className="rounded-full bg-brand px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-deep">
        Open my trip
      </Link>
    </main>
  );
