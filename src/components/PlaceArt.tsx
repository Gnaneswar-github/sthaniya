...
const GLYPHS: Record<Category | "place", ReactPathSet> = {
  ...
  church: ["M12 2.5v4", "M10.2 4.3h3.6", "M6 20v-8.5l6-4.8 6 4.8V20", "M3 20h18", "M10.5 20v-3.8a1.5 1.5 0 0 1 3 0V20"],
  mosque: ["M7 20v-5.5a5 5 0 0 1 10 0V20", "M12 9.5V7", "M12 7c-.9-.8-.9-2 0-2.8", "M3.8 20V10l.9-1.8.9 1.8v10", "M3 20h18"],
  worship: ["M5 20V9.5L12 4l7 5.5V20", "M3 20h18", "M9.8 20v-4.5h4.4V20", "M12 8.2v3", "M10.5 9.7h3"],
